...
pacman -S --noconfirm base-devel konsole firefox gvim zip unzip openssh hunspell-en_US hunspell-es_any nextcloud-client pulseaudio-alsa pulseaudio-bluetooth dosfstools e2fsprogs nodejs npm tmux man-pages moreutils xclip khal todoman vdirsyncer python-keyring python-dbus kwallet bash-completion pkgfile ripgrep fzf gwenview okular dolphin inetutils
